...
echo -e  "Tools    : NINJA $white         " |lolcat
echo -e  "Creadby  : MRkuntul_   " |lolcat
echo -e  "Contact  : 081999265308 $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : NINJA_" | lolcat
exit
;;

*) echo "maag, pilihan yang lu cari kaga ada"
esac
done
done